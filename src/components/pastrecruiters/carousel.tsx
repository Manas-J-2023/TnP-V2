      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800">
            Past <span className="text-red-600">Tech Recruiters</span>
          </h2>
        </div>
        ...
        <div className="overflow-hidden mb-6">
          <div className="inline-flex whitespace-nowrap animate-[marquee_60s_linear_infinite]">
            {allLogos.map((recruiter, index) => (
              <div key={`first-${index}`} className="mx-4 w-[180px] flex-shrink-0">
        ...
        <div className="overflow-hidden">
          <div className="inline-flex whitespace-nowrap animate-[marquee-reverse_60s_linear_infinite]">
            {allSecondRowLogos.map((recruiter, index) => (
              <div key={`second-${index}`} className="mx-4 w-[180px] flex-shrink-0">
                <div className="p-4 bg-white h-24 flex items-center justify-center rounded-md">
                  <img src={recruiter.logo} alt={recruiter.name} className="max-h-12 max-w-full object-contain" />
                </div>
              </div>
        ...
        {/* Non-Tech Recruiters */}
        <div className="flex items-center justify-center mb-8">
          <Car className="text-blue-600 mr-3 h-6 w-6" />
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800">
            Past <span className="text-blue-600">Non-Tech Recruiters</span>
          </h2>
        </div>
        ...
        <div className="overflow-hidden mb-6">
          <div className="inline-flex whitespace-nowrap animate-[marquee_60s_linear_infinite]">
            {allLogos.map((recruiter, index) => (
              <div key={`first-nontech-${index}`} className="mx-4 w-[180px] flex-shrink-0">
                <div className="p-4 bg-white h-24 flex items-center justify-center rounded-md">
                  <img src={recruiter.logo} alt={recruiter.name} className="max-h-12 max-w-full object-contain" />
                </div>
              </div>
        ...
        <div className="overflow-hidden">
          <div className="inline-flex whitespace-nowrap animate-[marquee-reverse_60s_linear_infinite]">
            {allSecondRowLogos.map((recruiter, index) => (
              <div key={`second-nontech-${index}`} className="mx-4 w-[180px] flex-shrink-0">
                <div className="p-4 bg-white h-24 flex items-center justify-center rounded-md">
                  <img src={recruiter.logo} alt={recruiter.name} className="max-h-12 max-w-full object-contain" />
                </div>
              </div>
        ...
        <div className="flex items-center justify-center mb-8">
          <Car className="text-blue-600 mr-3 h-6 w-6" />
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-800">
            Past <span className="text-purple-600">Core Recruiters</span>
          </h2>
        </div>
